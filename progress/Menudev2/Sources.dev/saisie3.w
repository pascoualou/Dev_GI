...
DEFINE VARIABLE filNom AS CHARACTER 
...
DEFINE FRAME frmSaisie
     BtnOK AT ROW 6.48 COL 3 WIDGET-ID 4
     btnAbandon AT ROW 6.48 COL 31 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 80.8 BY 6.71 WIDGET-ID 100.

DEFINE FRAME frmModule
     filNom AT ROW 1.24 COL 2 NO-LABEL WIDGET-ID 2
...
DO:
    ENTRY(4,cParametres-io,"|") = filNom:SCREEN-VALUE IN FRAME frmModule.
    APPLY "WINDOW-CLOSE" TO c-win.
...
ON CTRL-A OF filNom IN FRAME frmModule
DO:
  DO WITH FRAME frmSaisie:
      filNom:SET-SELECTION(1,LENGTH(filNom:SCREEN-VALUE) + 100) NO-ERROR.
  END.
END.
