...
DO:
    AssigneParametre("DICO-CSV","TRUE").
...
DO:
  ...
  lParam = (DonneParametre("DICO-CSV") = "TRUE").
  ...
  DO WITH FRAME frmModule:
      ...
      */
      ...
      RUN ExtraitFichierDeLaBase("",cFichierModele).
...
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME frmModule:
        ...
        RUN AfficheMessageAvecTemporisation("Bases - Gestion Champs","Champs séléctionnés mis en presse-papier",FALSE,2,"OK","MESSAGE-COMMENTAIRE-CHAMPS-1",FALSE,OUTPUT cRetour).
    END.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME frmModule:
        ...
        IF LENGTH(cResultat) < 64000 THEN DO:
            ...
            RUN AfficheMessageAvecTemporisation("Bases - Gestion Champs","Code mis en presse-papier",FALSE,2,"OK","MESSAGE-COMMENTAIRE-CHAMPS-WEBGI",FALSE,OUTPUT cRetour).
        END.
        ELSE DO:
            ...
            PUT UNFORMATTED cTempo.
            OUTPUT CLOSE.
            RUN AfficheMessageAvecTemporisation("Bases - Gestion Champs","Trop gros pour le presse-papier. Code sauvé sous %s" + cFichierCode,FALSE,0,"OK","MESSAGE-COMMENTAIRE-CHAMPS-WEBGI-3",FALSE,OUTPUT cRetour).
        END.
    END.
END PROCEDURE.
