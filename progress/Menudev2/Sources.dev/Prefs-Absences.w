...
DO:
    SauvePreference("PREF-ABSENCES-PREVENU","").
    SupprimePreference("ABSENCES-SIGNALEES-*").
    RUN AfficheMessageAvecTemporisation("Absences","Flag réinitialisé !",FALSE,1,"OK","",FALSE,OUTPUT cRetour).
END.
...
DO:
    ...
    SauvePreference("PREFS-ABSENCES-PRESENTATION",cmbPresentation:SCREEN-VALUE).
    lRepercution = TRUE.
END.
...
DO:
    SauvePreference("PREFS-ABSENCES-JOURS",SELF:SCREEN-VALUE).
    lRepercution = TRUE.
END.
...
DO:
    SauvePreference("PREFS-ABSENCES-PAS-AVERTISSEMENT-WE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
    lRepercution = TRUE.
END.
...
DO:
    SauvePreference("PREFS-ABSENCES-PAS-WE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
    lRepercution = TRUE.
END.
...
DO:
    SauvePreference("PREFS-ABSENCES-FUTURES-PREVENIR",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    SauvePreference("PREFS-ABSENCES-JOUR-PREVENIR",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    SauvePreference("PREF-ABSENCES-PREVENIR-NOUVELLE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
...
DO:
    SauvePreference("PREF-ABSENCES-PREVENIR-NOUVELLE-DESUITE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    SauvePreference("PREFS-ABSENCES-UNE-PAR-LIGNE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
    lRepercution = TRUE.
END.
...
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME frmModule:
        tglPrevenirJour:CHECKED = (IF DonnePreference("PREFS-ABSENCES-JOUR-PREVENIR") = "OUI" THEN TRUE ELSE FALSE).
        tglPrevenirFutures:CHECKED = (IF DonnePreference("PREFS-ABSENCES-FUTURES-PREVENIR") = "OUI" THEN TRUE ELSE FALSE).
        filNombreJours:SCREEN-VALUE = DonnePreference("PREFS-ABSENCES-JOURS").
        tglPrevenirNouvelle:CHECKED = (IF DonnePreference("PREF-ABSENCES-PREVENIR-NOUVELLE") = "OUI" THEN TRUE ELSE FALSE).
        tglPrevenirNouvelleDeSuite:CHECKED = (IF DonnePreference("PREF-ABSENCES-PREVENIR-NOUVELLE-DESUITE") = "OUI" THEN TRUE ELSE FALSE).
        tglPasWE:CHECKED = (IF DonnePreference("PREFS-ABSENCES-PAS-WE") = "OUI" THEN TRUE ELSE FALSE).
        tglUneParLigne:CHECKED = (IF DonnePreference("PREFS-ABSENCES-UNE-PAR-LIGNE") = "OUI" THEN TRUE ELSE FALSE).
        tglPasAlerteWE:CHECKED = (IF DonnePreference("PREFS-ABSENCES-PAS-AVERTISSEMENT-WE") = "OUI" THEN TRUE ELSE FALSE).
        cmbPresentation:SCREEN-VALUE = DonnePreference("PREFS-ABSENCES-PRESENTATION").
