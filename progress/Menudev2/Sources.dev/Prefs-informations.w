...
DO:
      SauvePreference("INFOS-JOURS-MAX",SELF:SCREEN-VALUE).
END.
...
DO:
    SauvePreference("PREF-MESSAGES-DERNIER-INCORPORATION",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    SauvePreference("PREF-MESSAGES-DERNIER",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    SauvePreference("PREF-MESSAGES-DECROISSANT",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME frmModule:
        filJoursMessages:SCREEN-VALUE = DonnePreference("INFOS-JOURS-MAX").
        tglTriDecroissant:CHECKED = (IF DonnePreference("PREF-MESSAGES-DECROISSANT") = "OUI" THEN TRUE ELSE FALSE).
        tglDernierIncorporation:CHECKED = (IF DonnePreference("PREF-MESSAGES-DERNIER-INCORPORATION") = "OUI" THEN TRUE ELSE FALSE).
        tglDernierMessage:CHECKED = (IF DonnePreference("PREF-MESSAGES-DERNIER") = "OUI" THEN TRUE ELSE FALSE).
    END.
