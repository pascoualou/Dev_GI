...
DO:
    SauvePreference("PREF-HISTORIQUE-PREVENIR",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    SauvePreference("PREF-LIMITE-JOURNAL",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    SauvePreference("PREF-RECHERCHE-JOURNAL-SAUVEGARDE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME frmModule:
        tglLimiteJournal:CHECKED = (IF DonnePreference("PREF-LIMITE-JOURNAL") = "OUI" THEN TRUE ELSE FALSE).
        tglRechercheJournal:CHECKED = (IF DonnePreference("PREF-RECHERCHE-JOURNAL-SAUVEGARDE") = "OUI" THEN TRUE ELSE FALSE).
        tglHistorique:CHECKED = (IF DonnePreference("PREF-HISTORIQUE-PREVENIR") = "OUI" THEN TRUE ELSE FALSE).
    END.
