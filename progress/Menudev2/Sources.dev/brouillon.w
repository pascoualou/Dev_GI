...
DO:
    ...
    SauvePreference("PREF-BROUILLON-TOPMOST",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
------------------------------------------------------------------------------*/
    ...
    cWin-X = DonnePreference("PREF-BROUILLON-X").
    cWin-Y = DonnePreference("PREF-BROUILLON-Y").
    cWin-H = DonnePreference("PREF-BROUILLON-H").
    cWin-L = DonnePreference("PREF-BROUILLON-L").
    cWin-TOPMOST = DonnePreference("PREF-BROUILLON-TOPMOST").
    ...
    iMaxBrouillons = INTEGER(DonnePreference("PREF-MAX-BROUILLONS")).
    IF iMaxBrouillons = 0 THEN iMaxBrouillons = {&MAX_ONGLETS}.
    SauvePreference("PREF-MAX-BROUILLONS",STRING(iMaxBrouillons)).
...
/* Récupération du dernier brouillon utilisé */
    ...
    iBrouillon = INTEGER(DonnePreference("PREF-DERNIER-BROUILLON")).
...
------------------------------------------------------------------------------*/
    ...
    SauvePreference("PREF-BROUILLON-X",STRING(c-win:X)).
    SauvePreference("PREF-BROUILLON-Y",STRING(c-win:Y)).
    SauvePreference("PREF-BROUILLON-H",STRING(c-win:HEIGHT-P)).
    SauvePreference("PREF-BROUILLON-L",STRING(c-win:WIDTH-P)).
...
------------------------------------------------------------------------------*/
    ...
    IF NOT(lChargementEnCours) THEN DO:
        SauvePreference("PREF-DERNIER-BROUILLON",STRING(iOnglet)).
    END.
