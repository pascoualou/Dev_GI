...
DO:
    SauvePreference("PREFS_AFAIRE_RECHERCHE_DESCENDANTE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME frmModule:
        tglRechercheDescendante:CHECKED = (IF DonnePreference("PREFS_AFAIRE_RECHERCHE_DESCENDANTE") = "OUI" THEN TRUE ELSE FALSE).
    END.
