...
DO:
    SauvePreference("PREF-ALERTEJOUR",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    SauvePreference("PREF-PASAGENDA",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    SauvePreference("PREF-PASALERTESADMIN",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    SauvePreference("PREF-TITREMESSAGE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME frmModule:
        tglPasAgenda:CHECKED = (IF DonnePreference("PREF-PASAGENDA") = "OUI" THEN TRUE ELSE FALSE).
        tglPasALertesAdmin:CHECKED = (IF DonnePreference("PREF-PASALERTESADMIN") = "OUI" THEN TRUE ELSE FALSE).
        tglAlerteJour:CHECKED = (IF DonnePreference("PREF-ALERTEJOUR") = "OUI" THEN TRUE ELSE FALSE).
        tglTitreMessage:CHECKED = (IF DonnePreference("PREF-TITREMESSAGE") = "OUI" THEN TRUE ELSE FALSE).
    END.
