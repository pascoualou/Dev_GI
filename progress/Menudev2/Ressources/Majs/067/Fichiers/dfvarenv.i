...
DEFINE {1} VARIABLE Disque_Racine	AS CHARACTER	NO-UNDO.
...
DEFINE {1} VARIABLE WEBPATH	AS CHARACTER	FORMAT "x(512)" NO-UNDO.

DEFINE {1} VARIABLE imprimante	AS CHARACTER	NO-UNDO.

DEFINE {1} VARIABLE prowin	AS CHARACTER	NO-UNDO.
DEFINE {1} VARIABLE Version_OE	AS CHARACTER	NO-UNDO.
DEFINE {1} VARIABLE Suffixe	AS CHARACTER	NO-UNDO.