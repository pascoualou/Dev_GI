...
ASSIGN
	...
	Disque_Racine 	= Disque
	Reseau 	= os-getenv("reseau")
	Util	= os-getenv("devusr")
	dlc	= os-getenv("DLC")
	windows	= os-getenv("windir")
	.
IF os-getenv("disquedev") <> ? THEN Disque_Racine 	= os-getenv("disquedev").
...
ASSIGN
	...
	loc_outils = Disque_Racine + loc_outils
	loc_outadb = loc_outils + "\adb"
	loc_outgest = loc_outils + "\gest"
	loc_outcadb = loc_outils + "\cadb"
	loc_outtrans = loc_outils + "\trans"
	loc_appli = Disque_Racine + loc_appli
	loc_appdev = Disque_Racine + loc_appdev
	loc_tmp = Disque_Racine + loc_tmp
	loc_log = Disque_Racine + loc_log
	loc_intf = Disque_Racine + loc_intf
	.
