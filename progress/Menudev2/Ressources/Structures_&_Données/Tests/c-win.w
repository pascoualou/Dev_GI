...
DEFINE FRAME FRAME-A
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 2 ROW 1.24
         SIZE 77 BY 15.48
         TITLE "Frame A" DROP-TARGET WIDGET-ID 200.
...
ON MOUSE-MOVE-UP OF FRAME FRAME-A /* Frame A */
DO:
  
    message "Mouse-move-up" view-as alert-box.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FRAME-A C-Win
ON MOUSE-SELECT-UP OF FRAME FRAME-A /* Frame A */
DO:
  
    message "mouse-select-up" view-as alert-box.
END.
