...
echo DLC=%DLC%
echo DEVUSR=%DEVUSR%
start %DLC%\bin\%PROWIN% -zn -mmax 4000 -pf %CONNEXION% -p "h:\dev\outils\Progress\Menudev2\sources.dev\menudev2.w" -ininame h:\dev\outils\Progress\developpementGI.ini -T %disque%tmp -h 20 -param ",ppl.dev;NO-VERSION ADMIN"
rem pause
exit