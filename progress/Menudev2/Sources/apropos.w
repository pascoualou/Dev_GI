...
------------------------------------------------------------------------------*/
    ...
    /* Infos */
    gLigne("#VIDE#",1).
    gTitre("Environnement :",1).
    gTabulation(1).
        gLigne("VERSION = " + string(giVersionUtilisateur,"999"),1).
        gLigne("DEVUSR = " + gcUtilisateur,1).
        gLigne("TEMP = " + OS-GETENV("TEMP"),1).
        gLigne("TMP = " + OS-GETENV("TMP"),1).
        gLigne("DISQUE = " + OS-GETENV("DISQUE"),1).
        gLigne("DISQUE-WEB = " + OS-GETENV("DISQUE-WEB"),1).
        gLigne("RESEAU = " + OS-GETENV("RESEAU"),1).
        gLigne("RESEAUBIS = " + (IF OS-GETENV("RESEAUBIS") <> ? THEN OS-GETENV("RESEAUBIS") ELSE ""),1).
        gLigne("PROVERSION = " + PROVERSION,1).
        gLigne("DLC = " + OS-GETENV("DLC"),1).
        gLigne("DLC_V10 = " + OS-GETENV("DLC_V10"),1).
        gLigne("DLC_V11 = " + OS-GETENV("DLC_V11"),1).
        gLigne("PROWIN = " + OS-GETENV("PROWIN"),1).
        gLigne("PROPATH = " + OS-GETENV("PROPATH"),1).
        gLigne("PROPATH-SPECIFIQUE = " + OS-GETENV("PROPATH-SPECIFIQUE"),1).
        gLigne("PROBUILD = " + OS-GETENV("PROBUILD"),1).
        gLigne("PROMSGS = " + OS-GETENV("PROMSGS"),1).
        gLigne("REPGI = " + OS-GETENV("REPGI"),1).
        gLigne("PATH = " + OS-GETENV("PATH"),1).
        gLigne("PROFILE_BLAT = " + (IF OS-GETENV("PROFILE_BLAT") <> ? THEN OS-GETENV("PROFILE_BLAT") ELSE ""),1).
        gLigne("VERSION_OE = " + OS-GETENV("VERSION_OE"),1).
        gLigne("SUFFIXE = " + OS-GETENV("SUFFIXE"),1).
        gLigne("VERBOSE = " + OS-GETENV("VERBOSE"),1).
    gTabulation(-1).
