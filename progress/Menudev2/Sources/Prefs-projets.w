...
DO:
      gSauvePreference("PREF-FILTRESPROJETS",SELF:SCREEN-VALUE).
END.
...
DO:
      gSauvePreference("PROJETS_REPERTOIRE_PERE",SELF:SCREEN-VALUE).
END.
...
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME frmModule:
        filFiltres:SCREEN-VALUE = gDonnePreference("PREF-FILTRESPROJETS").
        filRepertoirePereProjets:SCREEN-VALUE = gDonnePreference("PROJETS_REPERTOIRE_PERE").
    END.
