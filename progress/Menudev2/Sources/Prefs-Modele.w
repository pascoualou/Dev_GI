...
DEFINE VARIABLE tglModele AS LOGICAL INITIAL no 
...
DEFINE FRAME frmModule
     tglModele AT ROW 1.48 COL 3 WIDGET-ID 20
...
&Scoped-define SELF-NAME tglModele
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tglModele frmPrefs
ON VALUE-CHANGED OF tglModele IN FRAME frmModule /* Libelle du modele */
DO:
    gSauvePreference("PREF-xxx",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME frmModule:
        tglModele:CHECKED = (IF gDonnePreference("PREF-xxx") = "OUI" THEN TRUE ELSE FALSE).
    END.
