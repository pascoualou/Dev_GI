...
------------------------------------------------------------------------------*/
    ...
    IF fichiers.texte <> edtfichier:SCREEN-VALUE IN FRAME frame-a THEN DO:
        ...
        RUN gAfficheMessageTemporaire("Gestion des bases",cLibelle,TRUE,15,"NON","",FALSE,OUTPUT cRetour).
...
DEFINE VARIABLE cFichierEdition AS CHARACTER NO-UNDO INIT "".
    ...
    DO WITH FRAME Frame-B:
        ...
        RUN gImpressionFichier(cFichierEdition,"Fichier").
    END.
    END.
...
------------------------------------------------------------------------------*/
    ...
    cInfosFichier = gGetParam("FICHIERS-INFOSFICHIER").
    gSupParam("FICHIERS-INFOSFICHIER").
