...
------------------------------------------------------------------------------*/
    ...
    cPerso = gDonnePreference("CODIFICATION-PERSO").

    DO WITH FRAME frmCodification:
        cLigne = gDonnePreference("CODIFICATION-SYS_PR").
        FOR EACH    sys_pr  NO-LOCK
            WHERE   sys_pr.tppar = "#####"
           ...
           ,EACH    sys_lb  NO-LOCK
            ...
            ASSIGN
                ...
                .
        END.
        cLigne = gDonnePreference("CODIFICATION-SYS_PG").
        FOR EACH    sys_pg  NO-LOCK
            WHERE   sys_pg.tppar = "#####"
           ...
           ,EACH    sys_lb  NO-LOCK
            ...
            ASSIGN
                ...
                .
        END.
        cLigne = gDonnePreference("CODIFICATION-PCLIE").
        FOR EACH    pclie  NO-LOCK
            WHERE   TRUE
