...
filRappelDebut filRappelFin tglMuet tglWord filRepertoires tglBatch ~
Btnbatch tglBatch2 Btnbatch-2 tglMinutes Btnbatch-3 tglVersionManuelle ~
...
filRappelDebut filRappelFin tglMuet tglWord filRepertoires tglBatch ~
tglBatch2 tglMinutes tglVersionManuelle tglSaisieMasterGI tglSaisieInternet ~
...
DEFINE VARIABLE filRepertoires AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN NATIVE 
...
DEFINE FRAME frmFonction
     ...
     filRepertoires AT ROW 16.48 COL 81 NO-LABEL WIDGET-ID 22
...
DEFINE FRAME frmFonction
     ...
     "Débug et Développement" VIEW-AS TEXT
          ...
          BGCOLOR 3 FONT 6
     "Répertoire(s) où copier les fichier adbxxxxx (séparateur : virgule) :" VIEW-AS TEXT
          SIZE 64 BY .95 AT ROW 15.52 COL 81 WIDGET-ID 228
...
/* SETTINGS FOR FILL-IN filRappelFin IN FRAME frmFonction
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN filRepertoires IN FRAME frmFonction
   ALIGN-L                                                              */
...
DO:
    ...
    gSauvePreference("BATCH-CLIENT-PREC","H:\dev\outils\progress\Menudev2\Ressources\Scripts\session\Lancement.bat PREC H:\dev\outils\progress\Menudev2\Ressources\Scripts\session\LanceAppliGI.bat").
    gSauvePreference("BATCH-CLIENT","H:\dev\outils\progress\Menudev2\Ressources\Scripts\session\Lancement.bat CLI H:\dev\outils\progress\Menudev2\Ressources\Scripts\session\LanceAppliGI.bat").
    gSauvePreference("BATCH-CLIENT-SUIV","H:\dev\outils\progress\Menudev2\Ressources\Scripts\session\Lancement.bat SUIV H:\dev\outils\progress\Menudev2\Ressources\Scripts\session\LanceAppliGI.bat").
    gSauvePreference("BATCH-CLIENT-SPE","H:\dev\outils\progress\Menudev2\Ressources\Scripts\session\Lancement.bat SPE H:\dev\outils\progress\Menudev2\Ressources\Scripts\session\LanceAppliGI.bat").
...
DO:
    gSauvePreferenceGenerale("PREFS-GENE-ANCIENNES-SAUVEGARDES",SELF:SCREEN-VALUE).
END.
...
DO:
    ...
    gSauvePreference("PREF-MAX-BROUILLONS",STRING(iBrouillons)).
    gSauvePreference("PREF-BROUILLON",(IF iBrouillons > 0 THEN "OUI" ELSE "NON")).
END.
...
DO:
      gSauvePreference("PREF-CONTROLE-QUOTA-VALEUR",SELF:SCREEN-VALUE).
END.
...
DO:
      gSauvePreference("EMAIL-UTILISATEUR",SELF:SCREEN-VALUE).
END.
...
DO:
      gSauvePreferenceGenerale("JOURSFERIESFIXES",SELF:SCREEN-VALUE).
END.
...
DO:
    gSauvePreferenceGenerale("JOURSFERIESMOBILES",SELF:SCREEN-VALUE).
END.
...
DO:
    ...
    gSauvePreference("PREF-PASSEINTERNET",SELF:SCREEN-VALUE).
...
DO:
    ...
    gSauvePreference("PREF-PASSEINTERNETUTIL",SELF:SCREEN-VALUE).
END.
...
DO:
      gSauvePreference("LATENCE-INTERNET",SELF:SCREEN-VALUE).
...
DO:
      gSauvePreference("LATENCE-MASTERGI",SELF:SCREEN-VALUE).
...
DO:
      gSauvePreference("PREF-DEBUTRAPPELHORAIRE",SELF:SCREEN-VALUE).
...
DO:
      gSauvePreference("PREF-FINRAPPELHORAIRE",SELF:SCREEN-VALUE).
...
&Scoped-define SELF-NAME filRepertoires
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL filRepertoires C-Win
ON LEAVE OF filRepertoires IN FRAME frmFonction
DO:
      gSauvePreference("REPERTOIRES-APPLI",SELF:SCREEN-VALUE).
END.
...
DO:
    gSauvePreference("PREF-DEMON_TICKETS-REPERTOIRE",SELF:SCREEN-VALUE).
END.
...
DO:
      gSauvePreferenceGenerale("VACANCES-SCOLAIRES",SELF:SCREEN-VALUE).
END.
...
DO:
      gSauvePreference("PREF-VRAI-NOM",SELF:SCREEN-VALUE).
END.
...
DO:
    gSauvePreference("PREF-EXECUTIONBATCHENTREE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-EXECUTIONBATCHSORTIE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-BOUTONSNORMAUX",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-BY-PASS-HORAIRE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
...
DO:
    ...
    gSauvePreference("COMMANDESDOSVISIBLES",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
...
DO:
    ...
    gSauvePreference("PREF-CONTROLE-ACTIF",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
    ...
    DO WITH FRAME frmfonction:
        IF SELF:CHECKED THEN DO:
            ...
            ASSIGN
                ...
                .
            gSauvePreference("PREF-CONTROLE-IDENT-AGENDA",agenda.cident).
        END.
        ELSE DO:
            /* Suppression de la tache de l'agenda */
            cIdentTache = gDonnePreference("PREF-CONTROLE-IDENT-AGENDA").
...
DO:
    gSauvePreference("PREF-CONTROLE-7Z",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-CONTROLE-BASEDOS",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-CONTROLE-BASE+SVG-PRESENTE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-CONTROLE-BASES",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
...
DO:
    gSauvePreference("PREF-CONTROLE-DISPONIBLE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
...
DO:
    gSauvePreference("PREF-CONTROLE-QUOTA",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-CONTROLE-EXCLUS",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-CONTROLE-MAIL",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-CONTROLE-QUE-SI-ERREUR",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-CONTROLE-SVG-PRESENTE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-CONTROLE-VISU-LOG",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-DEMON_TICKETS",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
...
DO:
    gSauvePreference("PREF-DEMON_TICKETS-VERBOSE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
...
DO:
    gSauvePreference("PREF-DEVELOPPEUR",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-ACTIVELOG",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
...
DO:
    gSauvePreference("PREF-MEMOGENE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-EXECUTIONBATCHMINUTES",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-DERNIER-MODULE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-VOIRMODULESINVISIBLES",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-MODESILENCIEUX",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-POSITION",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREFS-MODULE-DIRECT",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
END.
...
DO:
    gSauvePreference("PREF-SAISIEINTERNET",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
...
DO:
    gSauvePreference("PREF-SAISIEMASTERGI",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
...
DO:
    gSauvePreference("AIDE-BOUTON-MANUELLE",(IF SELF:CHECKED THEN "OUI" ELSE "NON")).
...
------------------------------------------------------------------------------*/
  DISPLAY tglPrefsDirect filVraiNom filEmail tglSortie tglPosition tglModule 
          ...
          tglMuet tglWord filRepertoires tglBatch tglBatch2 tglMinutes 
          tglVersionManuelle tglSaisieMasterGI tglSaisieInternet filMastergi 
  ...
  ENABLE RECT-2 RECT-12 RECT-13 RECT-14 RECT-15 RECT-16 RECT-9 RECT-17 
         ...
         tglDemonTicketVerbose tglDeveloppeur tglby-pass tglLog tglCommandesDos 
         tglModuleInvisibles tglControle tglControleVoir tglControleMail 
         tglControleQueSiErreur tglControleBases tglControleSvg 
         tglControleBaseEtSvg tglControle7z tglControleExclus 
         tglControleBaseDos tglControleDisponible tglControleDispoQuota 
         filControleQuotaValeur filFeriesFixes filVacancesScolaires 
         filFeriesMobiles filAnciennes 
...
------------------------------------------------------------------------------*/
    ...
    IF integer(gDonnePreference("LATENCE-MASTERGI")) = 0 THEN gSauvePreference("LATENCE-MASTERGI","1").
    IF gDonnePreference("REPERTOIRES-APPLI") = "" THEN gSauvePreference("REPERTOIRES-APPLI",disque + "gidev").
    IF gDonnePreference("PREF-DEBUTRAPPELHORAIRE") = "" THEN gSauvePreference("PREF-DEBUTRAPPELHORAIRE","09").
    IF gDonnePreference("PREF-FINRAPPELHORAIRE") = "" THEN gSauvePreference("PREF-FINRAPPELHORAIRE","17").
    IF gDonnePreference("PREF-SAISIEMASTERGI") = "" THEN gSauvePreference("PREF-SAISIEMASTERGI","OUI").
    IF gDonnePreference("PREF-FILTRESPROJETS") = "" THEN gSauvePreference("PREF-FILTRESPROJETS","*.doc,*.xls,*.pdf,*.7z,*.zip,*.jpg,*.jpeg,*.txt").
    IF integer(gDonnePreference("PREF-MAX-BROUILLONS")) = 0 THEN gSauvePreference("PREF-MAX-BROUILLONS","5").
...
------------------------------------------------------------------------------*/
    ...
    cProgPrefs = gcRepertoireExecution + "prefs-" + gDonneProgramme(cIdentModule-in) + ".w".
...
------------------------------------------------------------------------------*/
    ...
    lValeur = gdonnepreference("PREF-CONTROLE-BASES") = "OUI".
...
------------------------------------------------------------------------------*/
    ...
    lValeur = gdonnepreference("PREF-CONTROLE-ACTIF") = "OUI".
...
------------------------------------------------------------------------------*/
    ...
    lValeur = gdonnepreference("PREF-CONTROLE-DISPONIBLE") = "OUI".
...
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME frmFonction:   
        ...
        tglControle:CHECKED = (IF gDonnePreference("PREF-CONTROLE-ACTIF") = "OUI" THEN TRUE ELSE FALSE).
        /*RUN MiseAJourOptionsControle.*/
        tglControleMail:CHECKED = (IF gDonnePreference("PREF-CONTROLE-MAIL") = "OUI" THEN TRUE ELSE FALSE).
        tglControleQueSiErreur:CHECKED = (IF gDonnePreference("PREF-CONTROLE-QUE-SI-ERREUR") = "OUI" THEN TRUE ELSE FALSE).
        tglControleBases:CHECKED = (IF gDonnePreference("PREF-CONTROLE-BASES") = "OUI" THEN TRUE ELSE FALSE).
        tglControleBaseDos:CHECKED = (IF gDonnePreference("PREF-CONTROLE-BASEDOS") = "OUI" THEN TRUE ELSE FALSE).
        tglControleVoir:CHECKED = (IF gDonnePreference("PREF-CONTROLE-VISU-LOG") = "OUI" THEN TRUE ELSE FALSE).
        tglControleDisponible:CHECKED = (IF gDonnePreference("PREF-CONTROLE-DISPONIBLE") = "OUI" THEN TRUE ELSE FALSE).
        tglControleSvg:CHECKED = (IF gDonnePreference("PREF-CONTROLE-SVG-PRESENTE") = "OUI" THEN TRUE ELSE FALSE).
        tglControleBaseEtSvg:CHECKED = (IF gDonnePreference("PREF-CONTROLE-BASE+SVG-PRESENTE") = "OUI" THEN TRUE ELSE FALSE).
        tglControle7z:CHECKED = (IF gDonnePreference("PREF-CONTROLE-7Z") = "OUI" THEN TRUE ELSE FALSE).
        tglControleExclus:CHECKED = (IF gDonnePreference("PREF-CONTROLE-EXCLUS") = "OUI" THEN TRUE ELSE FALSE).
        tglControleDispoQuota:CHECKED = (IF gDonnePreference("PREF-CONTROLE-QUOTA") = "OUI" THEN TRUE ELSE FALSE).
        filControleQuotaValeur:SCREEN-VALUE = gDonnePreference("PREF-CONTROLE-QUOTA-VALEUR").
        
        IF integer(filControleQuotaValeur:SCREEN-VALUE) = 0 THEN DO:
            filControleQuotaValeur:SCREEN-VALUE = "10".
            gSauvePreference("PREF-CONTROLE-QUOTA-VALEUR",filControleQuotaValeur:SCREEN-VALUE).
        END.
        RUN MiseAJourOptionsControle.

        tglModule:CHECKED = (IF gDonnePreference("PREF-DERNIER-MODULE") = "OUI" THEN TRUE ELSE FALSE).
        filEmail:SCREEN-VALUE = gDonnePreference("EMAIL-UTILISATEUR").
        filVraiNom:SCREEN-VALUE = gDonnePreference("PREF-VRAI-NOM").
        tglPosition:CHECKED = (IF gDonnePreference("PREF-POSITION") = "OUI" THEN TRUE ELSE FALSE).
        tglSortie:CHECKED = (IF gDonnePreference("PREF-SORTIE") = "OUI" THEN TRUE ELSE FALSE).
        tglMemo:CHECKED = (IF gDonnePreference("PREF-MEMOGENE") = "OUI" THEN TRUE ELSE FALSE).
        tglLog:CHECKED = (IF gDonnePreference("PREF-ACTIVELOG") = "OUI" THEN TRUE ELSE FALSE).
        tglModuleInvisibles:CHECKED = (IF gDonnePreference("PREF-VOIRMODULESINVISIBLES") = "OUI" THEN TRUE ELSE FALSE).
        tglMuet:CHECKED = (IF gDonnePreference("PREF-MODESILENCIEUX") = "OUI" THEN TRUE ELSE FALSE).
        tglSaisieMasterGI:CHECKED = (IF gDonnePreference("PREF-SAISIEMASTERGI") = "OUI" THEN TRUE ELSE FALSE).
        filmastergi:SCREEN-VALUE = gDonnePreference("LATENCE-MASTERGI").
        filMastergi:SENSITIVE = tglSaisieMasterGI:CHECKED.
        filrepertoires:SCREEN-VALUE = gDonnePreference("REPERTOIRES-APPLI").
        tglModuleInvisibles:SENSITIVE = glUtilisateurAdmin.
        tglBatch:CHECKED = (IF gDonnePreference("PREF-EXECUTIONBATCHENTREE") = "OUI" THEN TRUE ELSE FALSE).
        tglBatch2:CHECKED = (IF gDonnePreference("PREF-EXECUTIONBATCHSORTIE") = "OUI" THEN TRUE ELSE FALSE).
        tglMinutes:CHECKED = (IF gDonnePreference("PREF-EXECUTIONBATCHMINUTES") = "OUI" THEN TRUE ELSE FALSE).
        filRappelDebut:SCREEN-VALUE = gDonnePreference("PREF-DEBUTRAPPELHORAIRE").
        filRappelFin:SCREEN-VALUE = gDonnePreference("PREF-FINRAPPELHORAIRE").
        tglBoutonsNormaux:CHECKED = (IF gDonnePreference("PREF-BOUTONSNORMAUX") = "OUI" THEN TRUE ELSE FALSE).
        tglDeveloppeur:CHECKED = (IF gDonnePreference("PREF-DEVELOPPEUR") = "OUI" THEN TRUE ELSE FALSE).
        tglWord:CHECKED = (IF gDonnePreference("PREF-EDITIONSWORD") = "OUI" THEN TRUE ELSE FALSE).
        filBrouillons:SCREEN-VALUE = gDonnePreference("PREF-MAX-BROUILLONS").

        IF OS-GETENV("VOIR_COMMANDES_DOS") = "oui" THEN 
            gSauvePreference("COMMANDESDOSVISIBLES","oui").
        ELSE 
            gSauvePreference("COMMANDESDOSVISIBLES","non").
        tglCommandesDos:CHECKED = (IF gDonnePreference("COMMANDESDOSVISIBLES") = "OUI" THEN TRUE ELSE FALSE).
    
        filInternet:SCREEN-VALUE = gDonnePreference("PREF-PASSEINTERNET").
        filInternetUtil:SCREEN-VALUE = gDonnePreference("PREF-PASSEINTERNETUTIL").
        tglSaisieInternet:CHECKED = (IF gDonnePreference("PREF-SAISIEINTERNET") = "OUI" THEN TRUE ELSE FALSE).
        filLatenceInternet:SCREEN-VALUE = gDonnePreference("LATENCE-INTERNET").
        ...
        filFeriesFixes:SCREEN-VALUE = gDonnePreferenceGenerale("JOURSFERIESFIXES").
        filFeriesMobiles:SCREEN-VALUE = gDonnePreferenceGenerale("JOURSFERIESMOBILES").
        filAnciennes:SCREEN-VALUE = gDonnePreferenceGenerale("PREFS-GENE-ANCIENNES-SAUVEGARDES").
        tglVersionManuelle:CHECKED = (IF gDonnePreference("AIDE-BOUTON-MANUELLE") = "OUI" THEN TRUE ELSE FALSE).       
        tglPrefsDirect:CHECKED = (IF gDonnePreference("PREFS-MODULE-DIRECT") = "OUI" THEN TRUE ELSE FALSE).    
        filVacancesScolaires:SCREEN-VALUE = gDonnePreferenceGenerale("VACANCES-SCOLAIRES").
        
        tglDemonTicket:CHECKED = (IF gDonnePreference("PREF-DEMON_TICKETS") = "OUI" THEN TRUE ELSE FALSE).    
        tglby-pass:CHECKED = (IF gDonnePreference("PREF-BY-PASS-HORAIRE") = "OUI" THEN TRUE ELSE FALSE).

        glBy-Pass = tglby-pass:CHECKED.
        
        filRepertoireScan:SCREEN-VALUE = gDonnePreference("PREF-DEMON_TICKETS-REPERTOIRE").
        tglDemonTicketVerbose:CHECKED = (gDonnePreference("PREF-DEMON_TICKETS-VERBOSE") = "OUI").
