...
------------------------------------------------------------------------------*/
    ...
    FOR EACH    versions    NO-LOCK
        ...
        /* Ajout des moulinettes des patches */
        run RecupereMoulinettesPatches(iVersionDepart, iVersionArrivee).
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME frmfond:
      ...
      filRepertoirefichier:SCREEN-VALUE = RemplaceVariables(gcRepertoireMontage,"*",?,?).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE RecupereMoulinettesPatches winMontageVersion 
PROCEDURE RecupereMoulinettesPatches :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
define input parameter iVersionDepart-in as integer no-undo.
define input parameter iVersionArrivee-in as integer no-undo.
