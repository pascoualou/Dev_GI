...
start "" /B /WAIT %DLC%\bin\%PROWIN% -zn -mmax 4000 -pf %CONNEXION% -p _ab.p  -param "h:\dev\outils\progress\versions\sources.dev\versions.w"  -ininame "h:\dev\outils\progress\developpementGI.ini"

rem Menage avec un pause pour laisser à progress le temps de se fermer
call Menage_Progress.bat h:\dev\outils\progress\Versions\Sources.dev
