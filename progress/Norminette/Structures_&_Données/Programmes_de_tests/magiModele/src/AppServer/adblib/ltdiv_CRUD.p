...
procedure purgeLtdiv:
    ...
    for each ltdiv no-lock  
       where ltdiv.noref = integer(mToken:cRefPrincipale)
         and ltdiv.tpdiv = pcType
         and ltdiv.nodiv = piNumero:
        find current ltdiv exclusive-lock.     
        delete ltdiv.
    end.
