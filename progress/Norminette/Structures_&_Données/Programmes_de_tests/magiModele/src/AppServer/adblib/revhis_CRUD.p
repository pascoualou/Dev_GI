/*------------------------------------------------------------------------
File        : revhis_CRUD.p
Purpose     : Librairie contenant les procedures liées à la mise à jour de la table revhis
...
define variable ghttrevhis as handle no-undo.      // le handle de la temp table à mettre à jour
...
procedure readRevhis:
    /*------------------------------------------------------------------------------
    Purpose: Lecture d'un enregistrement de la table revhis 0908/0110 - histo traitements révisions 
    Notes  : service externe
    ------------------------------------------------------------------------------*/
...
procedure getRevhis:
    /*------------------------------------------------------------------------------
    Purpose: Lecture des enregistrements de la table revhis 0908/0110 - histo traitements révisions 
    Notes  : service externe.
    ------------------------------------------------------------------------------*/
    define input parameter table-handle phttRevhis.
    define variable vhttBuffer as handle  no-undo.
...
message "deleteRevhisSurContrat "  pcTypeContrat "// " piNumeroContrat.
