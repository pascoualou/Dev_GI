...
procedure purgeLtrol:
    ...
    for each ltrol no-lock
       where ltrol.noref = piReference
         and ltrol.tprol = pcTypeRole
         and ltrol.norol = piNumeroRole:
        find current ltrol exclusive-lock.     
        delete ltrol.
    end.
