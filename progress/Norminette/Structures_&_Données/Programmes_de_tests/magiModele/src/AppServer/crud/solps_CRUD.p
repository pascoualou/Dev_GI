...
procedure readSolps:
    /*------------------------------------------------------------------------------
    Purpose: Lecture d'un enregistrement de la table solps Stockage des soldes prestations quittancÃ©s suite Ã  D11
    Notes  : service externe
    ------------------------------------------------------------------------------*/
...
procedure getSolps:
    /*------------------------------------------------------------------------------
    Purpose: Lecture des enregistrements de la table solps Stockage des soldes prestations quittancÃ©s suite Ã  D11
...
procedure deleteSolpsSurMandat:
    /*------------------------------------------------------------------------------
