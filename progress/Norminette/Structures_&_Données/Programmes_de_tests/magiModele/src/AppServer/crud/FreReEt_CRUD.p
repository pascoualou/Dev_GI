...
procedure readFrereet:
    /*------------------------------------------------------------------------------
    Purpose: Lecture d'un enregistrement de la table FreReEt RIE : tableau  des fr̩quentations r̩elles (entete)
    Notes  : service externe
    ------------------------------------------------------------------------------*/
...
procedure getFrereet:
    /*------------------------------------------------------------------------------
    Purpose: Lecture des enregistrements de la table FreReEt RIE : tableau  des fr̩quentations r̩elles (entete)
...
blocTrans:
    do transaction:
        repeat:
            ...
            for each FreReDt exclusive-lock
                where FreReDt.tpcon = FreReEt.tpcon
                and   FreReDt.nocon = FreReEt.nocon
                and   FreReDt.noexo = FreReEt.noexo:
                delete FreReDt.
            end.
