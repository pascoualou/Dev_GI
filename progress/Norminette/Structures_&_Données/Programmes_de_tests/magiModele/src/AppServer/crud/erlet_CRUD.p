...
réponse : ix_erlet03 a été créé pour remplacer ix_erlet02 mais il fallait gérer l'existant le temps de mettre à jour les bases clients par moulinette.
          difficile de passer un index à Unique en PROD sur une table qui est utilisée depuis longtemps
          en final l'index devrait être tpcon+nocon+tpcpt+norlv et être unique 
-----------------------------------------------------------------------------*/
...
procedure readErletMandatNumeroReleve:
    /*------------------------------------------------------------------------------
    Purpose: Lecture d'un enregistrement de la table erlet à partir du mandat + type de relevé + no relevé
             NB : on ne doit plus utiliser noimm mais tpcon+nocon
                  un nouvel index a été créé pour la V19.00 
    Notes  : service externe
    ------------------------------------------------------------------------------*/
...
procedure getNextNumeroIdentifiantErlet private:
    ...
    Notes  :
    ------------------------------------------------------------------------------*/
    define output parameter piNextNorli as int64  no-undo initial 1.
    define buffer erlet for erlet.
