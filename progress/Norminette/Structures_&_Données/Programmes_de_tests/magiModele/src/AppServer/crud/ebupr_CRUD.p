...
procedure readEbupr:
    /*------------------------------------------------------------------------------
    Purpose: Lecture d'un enregistrement de la table ebupr budgets pr̩visionnels non valid̩s
    Notes  : service externe
    ------------------------------------------------------------------------------*/
...
procedure getEbupr:
    /*------------------------------------------------------------------------------
    Purpose: Lecture des enregistrements de la table ebupr budgets pr̩visionnels non valid̩s
    Notes  : service externe.
    ------------------------------------------------------------------------------*/
    define input parameter table-handle phttEbupr.
    define variable vhttBuffer as handle  no-undo.
