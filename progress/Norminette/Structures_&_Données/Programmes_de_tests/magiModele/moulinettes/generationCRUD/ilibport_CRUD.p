...
Purpose     : Librairie contenant les procedures liées à la mise à jour de la table ilibport
...
define variable ghttilibport as handle no-undo.      // le handle de la temp table à mettre à jour
