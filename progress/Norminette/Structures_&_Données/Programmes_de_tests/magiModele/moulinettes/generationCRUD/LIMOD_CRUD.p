/*------------------------------------------------------------------------
File        : LIMOD_CRUD.p
Purpose     : Librairie contenant les procedures liées à la mise à jour de la table LIMOD
...
define variable ghttLIMOD as handle no-undo.      // le handle de la temp table à mettre à jour
...
procedure getLimod:
    ...
    Notes  : service externe. Critère piNomod = ? si pas à prendre en compte
    ------------------------------------------------------------------------------*/
    define input parameter piNomod as integer    no-undo.
    define input parameter table-handle phttLimod.
    define variable vhttBuffer as handle  no-undo.
