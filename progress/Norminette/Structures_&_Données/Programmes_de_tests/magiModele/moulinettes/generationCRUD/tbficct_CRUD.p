/*------------------------------------------------------------------------
File        : tbficct_CRUD.p
Purpose     : Librairie contenant les procedures liées à la mise à jour de la table tbficct
...
define variable ghtttbficct as handle no-undo.      // le handle de la temp table à mettre à jour
