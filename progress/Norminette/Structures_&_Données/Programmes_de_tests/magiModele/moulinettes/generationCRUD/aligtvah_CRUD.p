...
Purpose     : Librairie contenant les procedures liées à la mise à jour de la table aligtvah
...
define variable ghttaligtvah as handle no-undo.      // le handle de la temp table à mettre à jour
