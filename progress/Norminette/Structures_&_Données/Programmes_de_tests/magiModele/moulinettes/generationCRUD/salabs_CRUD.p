/*------------------------------------------------------------------------
File        : salabs_CRUD.p
Purpose     : Librairie contenant les procedures liées à la mise à jour de la table salabs
...
define variable ghttsalabs as handle no-undo.      // le handle de la temp table à mettre à jour
