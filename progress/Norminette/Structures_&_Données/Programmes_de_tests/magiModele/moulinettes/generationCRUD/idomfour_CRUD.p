...
Purpose     : Librairie contenant les procedures liées à la mise à jour de la table idomfour
...
define variable ghttidomfour as handle no-undo.      // le handle de la temp table à mettre à jour
