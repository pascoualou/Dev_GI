/*------------------------------------------------------------------------
File        : crchcle_CRUD.p
Purpose     : Librairie contenant les procedures liées à la mise à jour de la table crchcle
...
define variable ghttcrchcle as handle no-undo.      // le handle de la temp table à mettre à jour
