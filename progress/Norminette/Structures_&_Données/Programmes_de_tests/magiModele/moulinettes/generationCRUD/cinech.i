/*------------------------------------------------------------------------
File        : cinech.i
Purpose     : detail amortissements
Author(s)   : generation automatique le 01/31/18
Notes       :
------------------------------------------------------------------------*/
&if defined(nomTable)   = 0 &then &scoped-define nomTable ttCinech
&endif
...
define temp-table {&nomTable} no-undo serialize-name '{&serialName}'
    ...
    field dadeb-ex       as date       initial ? 
    field dadep          as date       initial ? 
    field daech          as date       initial ? 
    field dafin-ex       as date       initial ? 
    field etab-cd        as integer    initial ? 
    field fg-appele      as logical    initial ? 
