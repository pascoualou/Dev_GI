/*------------------------------------------------------------------------
File        : csdtmp_CRUD.p
Purpose     : Librairie contenant les procedures liées à la mise à jour de la table csdtmp
...
define variable ghttcsdtmp as handle no-undo.      // le handle de la temp table à mettre à jour
