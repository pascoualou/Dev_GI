/*------------------------------------------------------------------------
File        : ifdjou_CRUD.p
Purpose     : Librairie contenant les procedures liées à la mise à jour de la table ifdjou
...
define variable ghttifdjou as handle no-undo.      // le handle de la temp table à mettre à jour
