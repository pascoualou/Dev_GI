/*------------------------------------------------------------------------
File        : clibsai_CRUD.p
Purpose     : Librairie contenant les procedures liées à la mise à jour de la table clibsai
...
define variable ghttclibsai as handle no-undo.      // le handle de la temp table à mettre à jour
