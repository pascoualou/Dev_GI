/*------------------------------------------------------------------------
File        : simapbco.i
Purpose     : 0607/0018 : simulation répartition d'un appel de fonds par copropriétaire/clé/lot
Author(s)   : generation automatique le 01/31/18
Notes       :
------------------------------------------------------------------------*/
&if defined(nomTable)   = 0 &then &scoped-define nomTable ttSimapbco
&endif
...
define temp-table {&nomTable} no-undo serialize-name '{&serialName}'
    ...
    field nobud     as decimal    initial ?  decimals 0
