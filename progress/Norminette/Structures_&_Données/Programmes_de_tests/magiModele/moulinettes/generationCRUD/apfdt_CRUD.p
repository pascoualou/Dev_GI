/*------------------------------------------------------------------------
File        : apfdt_CRUD.p
Purpose     : Librairie contenant les procedures liées à la mise à jour de la table apfdt
...
define variable ghttapfdt as handle no-undo.      // le handle de la temp table à mettre à jour
