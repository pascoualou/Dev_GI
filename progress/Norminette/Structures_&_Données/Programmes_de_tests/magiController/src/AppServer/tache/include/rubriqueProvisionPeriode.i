...
define temp-table {&nomTable} no-undo serialize-name '{&serialName}'
    ...
    field iNumeroPeriode        as integer   initial ? label "noexo" // numéro exercice charges locatives
    ...
    field dQuantiteRubrique     as decimal   initial ? decimals 3
    field dPrixUnitaireRubrique as decimal   initial ? decimals 3
